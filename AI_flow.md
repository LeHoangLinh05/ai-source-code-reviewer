...
### 4.1 Agent Pattern: ReAct (Reasoning + Acting)
...
```text
 ...
 │     + roadmap_compliance_summary (mục 3.6, dạng text)       │
 │                                                             │
 │  8. AGENT LẬP KẾ HOẠCH                                      │
 │     → gọi analyze_project_structure                         │
 │     → reasoning: chọn review order                          │
 │                                                             │
 │  9. AGENT REVIEW LOOP (cho mỗi file/chunk)                  │
