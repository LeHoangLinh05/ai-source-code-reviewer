...
export function RiskPostureCard({ posture }: { posture: RiskPosture }) {
  ...
  const hasScore = posture.score !== null;
  ...
  return (
    ...
    >
      ...
      <div className="grid gap-6 p-6 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-center lg:gap-8">
        ...
        <div className="flex shrink-0 items-center gap-6 rounded-md border border-border bg-background p-5 lg:min-w-[220px]">
          <div>
            <p className="text-xs font-medium uppercase text-muted-foreground">
              Overall score
            </p>
            <p className={cn("mt-1 text-4xl font-extrabold tabular-nums", tone.scoreText)}>
              {hasScore ? posture.score?.toFixed(1) : "--"}
